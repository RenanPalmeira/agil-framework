...
<div class="modal-content">
	<div class="modal-header">
		...
		<h3 class="modal-title font-open-sans">Editar item</h3>
	</div>
		...
		<div class="modal-body">
			<div class="container">
				<div class="form-group">
					...
					<input name="title" type="text" placeholder="Título do item" value="<?php echo $subItem['title'];?>" class="form-control">
				</div>
			</div>
		</div>
